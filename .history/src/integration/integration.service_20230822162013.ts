...
export class IntegrationService {
  ...
  async getdiagnosis(patientaddress: string) {
   ...
   async addDiagnosis(diagnosesCode : string, _date: number, adminsigner : any) : Promise<void> {
    ...
    await this.contract.addDiagnosis(diagnosesCode, timestamp, timestamp, si)
