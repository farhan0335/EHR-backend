...
export class IntegrationController {
    ...
    @Get('laboratory/:date')
    async getLaboratoryTest(@Param('date') patientAddress : string): Promise<{ testOrder: string; testCode: string; testName: string }> {
        return this.integrationService.getLaboratoryTest(pa);
    }
