import { Body, Controller, Get, HttpException, HttpStatus, Param, Post, Req, UploadedFile, UseGuards } from '@nestjs/common';
...
export class IntegrationController {
  ...
  async uploadFile(@Req() request: Request) {
    try {
      const file = request['file']; // Access the uploaded file from the request object
      ...
      // Handle the uploaded file here (e.g., save it to a database, perform processing, etc.)
