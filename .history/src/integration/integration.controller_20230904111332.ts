...
export class IntegrationController {
    ...
    @Get('diagnostic-study/:orderNumber')
    async getDianosticStudy(@Param("orderNumber") patientAddres: string) {
        return this.integrationService.getDiagnosticStudies(patientAddres)
    }
}
