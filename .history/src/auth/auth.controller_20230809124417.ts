import { Body, Controller, Param, Patch, Post, Req, Res, UseGuards, Headers} from '@nestjs/common';
...
async login(@Body() loginDto: AuthLoginDto): Promise<any> {
  ...
  @UseGuards(LocalAuthGuard)
   @Post('refresh-token')
  async refreshAccessToken(@Headers('authorization') authorization: string, @Res() res: Response) {
    try {
