...
import { Controller, Get, Post, Param, Delete, HttpCode, HttpStatus, UploadedFile, UseInterceptors, BadRequestException, NotFoundException, Res } from '@nestjs/common';
...
export class FilesController {
  ...
  @Get('/Get')
  async getFile(@Res() res : Response, @B)
}
